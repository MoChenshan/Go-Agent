...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/knowledge/vectorstore/elasticsearch v1.9.0
	trpc.group/trpc-go/trpc-agent-go/knowledge/vectorstore/pgvector v1.9.0
	trpc.group/trpc-go/trpc-agent-go/memory/mysql v1.9.0
	trpc.group/trpc-go/trpc-agent-go/memory/pgvector v1.9.0
	trpc.group/trpc-go/trpc-agent-go/memory/postgres v1.9.0
	trpc.group/trpc-go/trpc-agent-go/memory/redis v1.9.0
	trpc.group/trpc-go/trpc-agent-go/memory/sqlite v1.9.0
	trpc.group/trpc-go/trpc-agent-go/memory/sqlitevec v1.9.0
	trpc.group/trpc-go/trpc-agent-go/session/clickhouse v1.9.0
	trpc.group/trpc-go/trpc-agent-go/session/mysql v1.9.0
	trpc.group/trpc-go/trpc-agent-go/session/postgres v1.9.0
	trpc.group/trpc-go/trpc-agent-go/session/redis v1.9.0
	trpc.group/trpc-go/trpc-agent-go/session/sqlite v1.9.0
	trpc.group/trpc-go/trpc-agent-go/storage/clickhouse v1.9.0
	trpc.group/trpc-go/trpc-agent-go/storage/mysql v1.9.0
	trpc.group/trpc-go/trpc-agent-go/storage/postgres v1.9.0
	trpc.group/trpc-go/trpc-agent-go/storage/redis v1.9.0
