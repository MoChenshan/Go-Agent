...
- User says "remind me" but the request looks like a Clawdbot alert or automation task → default to `cron`/systemEvent handling and state that assumption briefly
