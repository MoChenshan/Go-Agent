...
func startChat(host string) {
	...
	// this http handler will hijack the http request and send it to the a2a server
	...
	a2aAgent, err := a2aagent.New(
		// agent card url is the url of the a2a server, http request already hijacked by the trpc http handler
		// this url provide sub path of your http req, it's /a2a here
		a2aagent.WithAgentCardURL("polaris://xxx.xxxx.xxx.xx/a2a"),
	...
	fmt.Println("💬 Chat with the remote agent")
	fmt.Println("Commands:")
	fmt.Println("  /new  - Start a new session")
	fmt.Println("  /exit - Quit the chat")
	fmt.Println()
