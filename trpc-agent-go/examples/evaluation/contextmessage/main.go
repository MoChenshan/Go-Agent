...
var (
	...
	evalSetID = flag.String("eval-set", "contextmessage-basic", "Evaluation set identifier to execute")
)

const appName = "contextmessage-app"

func main() {
	flag.Parse()
	ctx := context.Background()
	// New runner.
	runner := runner.NewRunner(appName, newContextMessageAgent(*modelName, *streaming))
