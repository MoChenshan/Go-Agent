module git.woa.com/trpc-go/trpc-agent-go/examples/lke

go 1.24.4

replace git.woa.com/trpc-go/trpc-agent-go => ../../

replace git.woa.com/trpc-go/trpc-agent-go/trpc/agent/lke => ../../trpc/agent/lke
...
require (
	...
	git.woa.com/trpc-go/trpc-agent-go/trpc/agent/lke v0.0.0-20260311021224-936e8dbcf354
	github.com/tencent-lke/lke-sdk-go v1.0.57
