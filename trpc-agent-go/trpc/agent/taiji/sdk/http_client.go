...
// WithHTTPTRPCClientOptions sets the tRPC client options for HTTP client.
func WithHTTPTRPCClientOptions(opts ...client.Option) HTTPClientOption {
...
func defaultClientBuilder(opts ...HTTPClientOption) HTTPClient {
	...
	client := ihttp.NewRequestHandler(options.Name, options.TRPCClientOptions...)
	return client
}
