...
const (
	modelName   = "your-model-name" // e.g.  hunyuan-turbos-latest
...
func newLLMAgentChat(modelName string, toolset tool.ToolSet) (*llmAgentChat, error) {
	...
	llmAgent := llmagent.New(
		"chat-with-text2image-toolset-agent",
		llmagent.WithModel(modelInstance),
		llmagent.WithDescription("A helpful AI assistant for image with text2image toolset"),
		llmagent.WithInstruction("You are a helpful AI assistant. Be conversational and engaging. "+
			"Answer questions clearly and provide helpful information. Use the tools in text2image toolset if needed."),
