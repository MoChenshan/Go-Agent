module git.woa.com/trpc-go/trpc-agent-go/trpc/storage/goes
...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/storage/elasticsearch v1.9.0
)
...
require (
	...
	trpc.group/trpc-go/trpc-agent-go v1.9.1 // indirect
