module git.woa.com/trpc-go/trpc-agent-go/trpc/telemetry/galileo
...
require (
	...
	git.woa.com/galileo/trpc-go-galileo v0.23.1-0.20250925023956-f7cd1ca11a48
...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/evaluation v1.9.0 // indirect
