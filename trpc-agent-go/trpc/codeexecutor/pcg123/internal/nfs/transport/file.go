...
// It implements io.Reader interface and handles NFS v3 READ operations.
...
// Write writes data from p to the file.
// It implements io.Writer interface and handles NFS v3 WRITE operations.
...
// OpenFile opens a file for writing, creating it if it doesn't exist.
// It returns a File that can be used for writing operations.
...
// It returns a File that can be used for reading operations.
