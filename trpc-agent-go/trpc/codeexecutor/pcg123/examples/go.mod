module git.woa.com/trpc-go/trpc-agent-go/trpc/codeexecutor/pcg123/examples

go 1.24.0

toolchain go1.24.10

replace git.woa.com/trpc-go/trpc-agent-go/trpc/codeexecutor/pcg123 => ../

require (
	git.woa.com/trpc-go/trpc-agent-go v1.6.1-0.20260311021224-936e8dbcf354
	git.woa.com/trpc-go/trpc-agent-go/trpc/codeexecutor/pcg123 v1.6.1-0.20260311021224-936e8dbcf354
...
require (
	...
	git.woa.com/trpcprotocol/agent/code_executor_admin_admin v1.1.25 // indirect
	git.woa.com/trpcprotocol/agent/code_executor_executor v1.1.13 // indirect
	git.woa.com/trpcprotocol/agent/code_executor_proxy_proxy v1.1.27 // indirect
