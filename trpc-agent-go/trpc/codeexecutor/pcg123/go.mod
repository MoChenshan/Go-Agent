module git.woa.com/trpc-go/trpc-agent-go/trpc/codeexecutor/pcg123
...
require (
	...
	git.woa.com/trpcprotocol/agent/code_executor_admin_admin v1.1.25
	git.woa.com/trpcprotocol/agent/code_executor_executor v1.1.13
	git.woa.com/trpcprotocol/agent/code_executor_proxy_proxy v1.1.27
