module git.woa.com/trpc-go/trpc-agent-go/test

go 1.24.4

replace git.woa.com/trpc-go/trpc-agent-go => ../

replace git.woa.com/trpc-go/trpc-agent-go/trpc/agui => ../trpc/agui
...
require (
	...
	git.woa.com/trpc-go/trpc-agent-go v1.6.1-0.20260311021224-936e8dbcf354 // indirect
